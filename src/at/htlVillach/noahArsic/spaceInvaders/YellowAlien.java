...
public class YellowAlien extends Alien {
    ...
    public YellowAlien(int x, int y, ID id, Handler handler, Game game, boolean isEnemy) {
        super(x, y, id, handler, game, isEnemy);
        image = loader.loadImage("Sprites/Alien2_0.gif");
    }
    ...
    protected void changeImage() {
        if (firstImage) image = loader.loadImage("Sprites/Alien2_0.gif");
        else image = loader.loadImage("Sprites/Alien2_1.gif");
    }
    ...
    protected void addToScore() {
        game.getHud().setScore(game.getHud().getScore() + 500);
    }
}
